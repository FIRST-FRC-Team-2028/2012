...
public class Loader
{
    ...
    public Loader()
    {
        Conveyor = new Victor(TwentyTwelve.LOADER_CONVEYOR_PWM);
        loaderInSolenoid = new Solenoid(TwentyTwelve.LOADER_IN_SOLENOID_CHANNEL);
        loaderOutSolenoid = new Solenoid(TwentyTwelve.LOADER_OUT_SOLENOID_CHANNEL);
        loaderUpSolenoid = new Solenoid(TwentyTwelve.LOADER_UP_SOLENOID_CHANNEL);
        loaderDownSolenoid = new Solenoid(TwentyTwelve.LOADER_DOWN_SOLENOID_CHANNEL);
        loaderIn = new DigitalInput(TwentyTwelve.LOAD_IN_GPIO_CHANNEL);
        loaderOut = new DigitalInput(TwentyTwelve.LOAD_OUT_GPIO_CHANNEL);
        loaderUp = new DigitalInput(TwentyTwelve.LOAD_UP_GPIO_CHANNEL);
        loaderDown = new DigitalInput(TwentyTwelve.LOAD_DOWN_GPIO_CHANNEL);

...
public class Wheel {
    ...
    {
        outputValue = (outputValue / 1.45 * ReboundRumble.MAX_MOTOR_VOLTAGE);
    ...
    public String toString()
    {
        ...
        try
        {
            message = "{speed: " + SteeringUnit.Normalize(motorController.getSpeed()) +
                    ", setpoint: " + SteeringUnit.Normalize(setpoint) + "}";
